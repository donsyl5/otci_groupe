            ...
            <div class="col-lg-12">
              <div class="white_card card_height_100 mb_30">
                ...
                <div class="white_card_body">
                  <div class="card-body">
                    <form action="{{ route ('storeMetier') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="mb-3">
                          <label class="form-label"
                            >Texte</label
                          >
                          <textarea name="texte" id="summernote" placeholder="Texte descriptif" cols="30" rows="10" class="form-control"></textarea>
                        </div>
