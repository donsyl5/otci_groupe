            ...
            <div class="col-lg-12">
              <div class="white_card card_height_100 mb_30">
                ...
                <div class="white_card_body">
                  <div class="card-body">
                    <form action="{{ route ('storeGroupe') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row mb-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <label class="form-label"
                            >Texte blog 1</label
                          >
                          <textarea name="texte1" id="" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <label class="form-label"
                            >Texte blog 2</label
                          >
                          <textarea name="texte2" id="" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <label class="form-label"
                            >Texte blog 3</label
                          >
                          <textarea name="texte3" id="" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                          <label class="form-label"
                            >Texte blog 4</label
                          >
                          <textarea name="texte4" id="" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                      </div>
