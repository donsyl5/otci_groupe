                                    ...
                                    <div class="white_box_tittle list_header">
                                        ...
                                        <div class="box_right d-flex lms_block">
                                            ...
                                            <div class="add_button ms-2">
                                                <a href="{{ route('realisation-a') }}" class="btn_1"
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        @foreach ($articles as $article)
                                            <tr>
                                                <td>{{ Illuminate\Support\Str::limit($article->titre, 50, '...') }}</td>
                                                <td>{{ $article->datee }}</td>


                                                <td> <img class="card-img-top"
                                                        src="{{ asset('upload/article/' . $article->image) }}"
                                                        title="" alt="" width="3"
                                                        style="height: 70px; width:70px;" /></td>
                                                <td>
                                                    <a href="{{ route('modifierActualite', $article->id) }}"
                                                        class="btn btn-primary" style="color : white;">Modifier</a>

                                                </td>
                                                <td> <button class="btn btn-danger"
                                                        onClick="deleteFunction('{{ $article->id }}')">Supprimer</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
