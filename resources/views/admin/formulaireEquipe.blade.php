            ...
            <div class="col-lg-12">
              <div class="white_card card_height_100 mb_30">
                ...
                <div class="white_card_body">
                  <div class="card-body">
                    <form action="{{ route ('storeEquipe') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input
                              ...
                              name="reseau"
                              id="reseau"
                              placeholder="Lien du Reseau social"
                            />
                          </div>
                      ...
                      <a href="{{ route('listeEquipe') }}" class="btn btn-primary">Annuler</a>
                    </form>
                  </div>
                </div>
              </div>
