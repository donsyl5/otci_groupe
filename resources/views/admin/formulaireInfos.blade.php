            ...
            <div class="col-lg-12">
              <div class="white_card card_height_100 mb_30">
                ...
                <div class="white_card_body">
                  <div class="card-body">
                    <form action="{{ route ('storeInfos') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input
                              ...
                              name="address"
                              id="address"
                              placeholder="Adresse complet de la page contact"
                            />
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input
                              ...
                              name="email"
                              id="email"
                              placeholder="Adresse email de la page contact"
                            />
                          </div>
                      ...
                      <a href="{{ route('infosContact') }}" class="btn btn-primary">Annuler</a>
                    </form>
                  </div>
                </div>
              </div>
