                                ...
                                <div class="card-body">
                                    <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label">Maitre</label>
                                                <input type="text" class="form-control" name="maitre" placeholder="Maitre" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Sous_categorie</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" name="galerie[]" multiple
                                                id="galerie" />
                                        </div>
