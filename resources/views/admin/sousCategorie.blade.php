            ...
            <div class="col-lg-12">
              <div class="white_card card_height_100 mb_30">
                ...
                <div class="white_card_body">
                  <div class="card-body">
                    <form method="POST" action="{{ route ('storeSousCategorie')}}">
                    @csrf
                      <div class="row mb-3">
                        <div class="col-md-6">
                ...
                <div class="white_card_body">
                  <div class="QA_section">
                    <div class="white_box_tittle list_header">
                      <h4>Table des sous categories</h4>
                    ...
                    <div class="QA_table mb_30">
                      <table class="table ">
                        ...
                        <tbody>
                          @foreach($sous_categorie as $categorie)
                          <tr>
                            <th scope="row">
                            ...
                            <td>
                                <a href="{{ route('modifierSousCategorie', $categorie->id )}}" class="btn btn-primary" style="color : white;">Modifier</a>
                                <button class="btn btn-danger" onClick="deleteFunction('{{ $categorie->id }}')">Supprimer</button>
                            </td>
...
@include('admin.modalSousCategorie')
